---
name: inspect
description: Inspect an existing Pyramid Task V3 or compatible legacy project without changing it. Use when an agent or a human needs status, ready or paused work, handoff identity, blockers, pending audits, baseline and impact coverage, stale inspections, scope drift, evidence gaps, task details, or the trace from a node to the final intent.
---

# Inspect a Pyramid Task Plan

Read `../../references/graph-contract.md`, `../../references/agent-contracts.md`, `../../references/handoff-contract.md`, `../../references/brownfield-assurance.md`, and `../../references/lifecycle-contract.md` completely before interpreting a graph.
